    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section id="get-started" className="px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white dark:bg-gray-950 p-8 rounded-lg shadow-lg border border-gray-200 dark:dark:border-gray-800">
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-500">
                Full platform access • AI routing • Professional exports • No
                setup fees
              </p>
            </div>
          </div>
